...
point_file = support.read_input(r'year_2021/input/13_transparent_origami_points.txt', 
                                flavor='split_int', split_char=',')
fold_file = support.read_input(r'year_2021/input/13_transparent_origami_folds.txt', 
